...
String chatID = ""; // Replace with your chat ID
...
sendTelegramMessage(" Alert: SHE IS IN DANGER!!! RESCUE!!!");
delay(1000); // Short delay to ensure requests don't collide
sendLocation(12.9716, 77.5946); // Replace with real coordinates if
needed
}
...
sendTelegramMessage(" Info: SHE IS SAFE NOW.");
}
}
